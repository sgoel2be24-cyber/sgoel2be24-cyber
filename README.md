...
| **[apache/airflow](https://github.com/apache/airflow)** | [#71691](https://github.com/apache/airflow/pull/71691) ✅ **merged** | `fix: resolve deprecated imports in airflow.utils.helpers` — the deprecation shim used bare `__import__` on dotted paths, returning the top-level module instead of the submodule, so moved functions like `render_template_as_native` raised `ImportError`. Switched to `importlib.import_module`, with regression tests. Landed as [`bb3e71d`](https://github.com/apache/airflow/commit/bb3e71da4669dc0323eda3651dac18a9eed57275). |
